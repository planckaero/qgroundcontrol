...
#define MAVLINK_MSG_ID_PLANCK_STATUS_LEN 7
#define MAVLINK_MSG_ID_PLANCK_STATUS_MIN_LEN 7
#define MAVLINK_MSG_ID_9003_LEN 7
#define MAVLINK_MSG_ID_9003_MIN_LEN 7

#define MAVLINK_MSG_ID_PLANCK_STATUS_CRC 24
#define MAVLINK_MSG_ID_9003_CRC 24
...
static inline uint16_t mavlink_msg_planck_status_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint8_t target_system, uint8_t target_component, uint8_t status, uint8_t failsafe, uint8_t takeoff_ready, uint8_t land_ready, uint8_t takeoff_complete)
{
...
{
    return mavlink_msg_planck_status_pack(system_id, component_id, msg, planck_status->target_system, planck_status->target_component, planck_status->status, planck_status->failsafe, planck_status->takeoff_ready, planck_status->land_ready, planck_status->takeoff_complete);
}
...
{
    return mavlink_msg_planck_status_pack_chan(system_id, component_id, chan, msg, planck_status->target_system, planck_status->target_component, planck_status->status, planck_status->failsafe, planck_status->takeoff_ready, planck_status->land_ready, planck_status->takeoff_complete);
}
...
static inline void mavlink_msg_planck_status_send(mavlink_channel_t chan, uint8_t target_system, uint8_t target_component, uint8_t status, uint8_t failsafe, uint8_t takeoff_ready, uint8_t land_ready, uint8_t takeoff_complete)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_PLANCK_STATUS_LEN];
    _mav_put_uint8_t(buf, 0, target_system);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_planck_status_send(chan, planck_status->target_system, planck_status->target_component, planck_status->status, planck_status->failsafe, planck_status->takeoff_ready, planck_status->land_ready, planck_status->takeoff_complete);
#else
 ...
 */
static inline void mavlink_msg_planck_status_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t target_system, uint8_t target_component, uint8_t status, uint8_t failsafe, uint8_t takeoff_ready, uint8_t land_ready, uint8_t takeoff_complete)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
