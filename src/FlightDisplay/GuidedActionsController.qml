...
Item {
    ...
    property bool showChangeAlt:        false
    property bool showWingman:          _guidedActionsEnabled && _vehicleFlying && activeVehicle.guidedModeSupported && _vehicleArmed && !_missionActive
