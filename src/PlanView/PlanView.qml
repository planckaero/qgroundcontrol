    ...
    function updateAirspace(reset) {
        if(_airspaceEnabled) {
            ...
            if(coordinateNW.isValid && coordinateSE.isValid) {
                _planMasterController.managerVehicle.airspaceVehicleManager.setROI(coordinateNW, coordinateSE, true /*planView*/, reset)
            }
        }
    }
        ...
        Item {
            ...
            Column {
                ...
                AirspaceControl {
                    ...
                    planView:       true
                    showColapse:    true
                    activeVehicle:  _planMasterController.managerVehicle
                }
                //-------------------------------------------------------
