...
public:
    ...
    Q_PROPERTY(FollowTargetMonitor* followTargetMonitor READ followTargetMonitor    CONSTANT)
    ...
    FollowTargetMonitor*    followTargetMonitor ()  { return _followTargetMonitor; }
...
private:
    ...
    FollowTargetMonitor*    _followTargetMonitor    = nullptr;
