...
DECLARE_SETTINGSFACT(FlyViewSettings, showAnnunciatorPanel)
DECLARE_SETTINGSFACT(FlyViewSettings, vibeMaxThreshold)
DECLARE_SETTINGSFACT(FlyViewSettings, tiltMaxThreshold)
