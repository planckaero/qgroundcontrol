...
DECLARE_SETTINGSFACT(AppSettings, sendTerrainCmds)
DECLARE_SETTINGSFACT(AppSettings, enableLARS)
DECLARE_SETTINGSFACT(AppSettings, larsVideoAddress)
DECLARE_SETTINGSFACT(AppSettings, larsRelayControlAddress)
DECLARE_SETTINGSFACT(AppSettings, larsRelayControlPort)
DECLARE_SETTINGSFACT(AppSettings, larsRelayListenPort)
