    ...
    APMCustomMode(mode, settable)
{
    setEnumToStringMapping({
        { STABILIZE,    "Stabilize"},
        { ACRO,         "Acro"},
        { ALT_HOLD,     "Control*: Manual"},
        { AUTO,         "Control: Mission"},
        { GUIDED,       "Control: Guided"},
        { LOITER,       "Control: Loiter"},
        { RTL,          "RecoverGnd: RTL"},
        { CIRCLE,       "Circle"},
        { LAND,         "RecoverGnd*: Land"},
        { DRIFT,        "Drift"},
        { SPORT,        "Sport"},
        { FLIP,         "Flip"},
        { AUTOTUNE,     "Autotune"},
...
#endif
        { ZIGZAG,       "ZigZag" },
        { PLANCK_TRACK,   "LaunchVeh: Planck Track" },
        { PLANCK_RTB,     "RecoverVeh: Planck RTB" },
        { PLANCK_LAND,    "RecoverVeh*: Planck Land" },
