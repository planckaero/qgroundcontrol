    ...
    APMCustomMode(mode, settable)
{
    setEnumToStringMapping({
        { STABILIZE,    "Stabilize"},
        { ACRO,         "Acro"},
        { ALT_HOLD,     "Altitude Hold (Manual)"},
        { AUTO,         "Auto (Mission)"},
        { GUIDED,       "Guided (Go-to)"},
        { LOITER,       "Loiter (Dismounted)"},
        { RTL,          "RTL (Dismounted)"},
        { CIRCLE,       "Circle"},
        { LAND,         "Land (Dismounted)"},
        { DRIFT,        "Drift"},
        { SPORT,        "Sport"},
        { FLIP,         "Flip"},
        { AUTOTUNE,     "Autotune"},
        { POS_HOLD,     "Position Hold (Manual)"},
        { BRAKE,        "Brake"},
        { THROW,        "Throw"},
...
#endif
        { ZIGZAG,       "ZigZag" },
        { PLANCK_TRACK,   "Planck Track (Mounted)" },
        { PLANCK_RTB,     "Planck RTB (Mounted)" },
        { PLANCK_LAND,    "Planck Land (Mounted)" },
